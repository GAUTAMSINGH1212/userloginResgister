    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <div className="w-64 bg-blue-800 text-white p-6">
        ...
        <ul className="mt-8 space-y-4">
          <li><a href="#" className="hover:bg-blue-700 p-2 rounded">Dashboard</a></li>
          <li><a href="#" className="hover:bg-blue-700 p-2 rounded">Profile</a></li>
          ...
          <li><a href="#" className="hover:bg-blue-700 p-2 rounded">Support</a></li>
          <li><a href="#" className="hover:bg-blue-700 p-2 rounded">Logout</a></li>
        </ul>
      </div>
...
<img src="https://via.placeholder.com/100" alt="User Avatar" className="rounded-full mr-6" />
            ...
            <button className="bg-blue-600 text-white px-4 py-2 mt-4 rounded">Edit Profile</button>
          </div>
        </div>
